...
public class FingerprintActivity extends BRActivity {
    ...
    private String getLimitText() {
        ...
        return String.format(getString(R.string.TouchIdSettings_spendingLimit), BRCurrency.getFormattedCurrencyString(this, "MONA", amount), BRCurrency.getFormattedCurrencyString(this, iso, curAmount));
    }
