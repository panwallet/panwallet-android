...
import static com.panwallet.R.color.white;
import static com.panwallet.tools.util.BRConstants.PLATFORM_ON;
import static com.panwallet.tools.util.BRConstants.SCANNER_REQUEST;
        ...
        unlockedImage.animate().alpha(1f).setListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(LoginActivity.this, PanActivity.class);
                        startActivity(intent);
