...
import com.panwallet.tools.animation.DecelerateOvershootInterpolator;
import com.panwallet.tools.security.AuthManager;
import com.panwallet.tools.security.FingerprintUiHelper;
...
//                dismiss();
    ...
    private void animateSignalSlide(final boolean reverse) {
        ...
        if (!reverse) {
            fingerPrintLayout.setTranslationY(layoutTY + PanActivity.screenParametersPoint.y);
